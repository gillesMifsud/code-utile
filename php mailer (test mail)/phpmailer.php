...
class PHPMailer
{
    ...
    public function createHeader()
    {
        ...
        if ($this->XMailer == '') {
            $result .= $this->headerLine(
                'X-Mailer',
                'Formulaire Web (http://www.sebastien-rolling.fr/)'
            );
        } else {
    ...
    public function addEmbeddedImage($path, $cid, $name = '', $encoding = 'base64', $type = '', $disposition = 'inline')
    {
        ...
        $this->attachment[] = array(
            0 => $path,
            1 => '',// $filename, // On évite l'affichage en tant que pièce jointe ""
            2 => '',// $name, // mais cela affiche quand même l'image en cid:
            3 => $encoding,
            4 => $type,
            5 => false, // isStringAttachment
            6 => $disposition,
